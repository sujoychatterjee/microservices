 ...
 */
// NOTE 04/19/2018: This file was already heavily customized, it's hard to tell what's the custom part.
// NOTE 04/19/2018: Updated the encodeForCSS with the latest version from the library (0.1.1)

(function ($) {
    var hasBeenInitialized = false;
    var default_immune = {'attr': [',', '.', '-', '_'], 'css': ['(', ',', '\'', '"', ')', ' '], 'js': [',', '.', '_', ' ']};
    var unsafeKeys = {'attr': [], 'css_key': ['behavior', '-moz-behavior', '-ms-behavior'], 'css_val'   : ['expression']};
    ...
    var methods = {html: function (opts) {
    ...
    var PushbackString = Class.extend({_input: null, _pushback: null, _temp: null, _index: 0, _mark: 0, _hasNext: function () {
    ...
    var Trie = Class.extend({root: null, maxKeyLen: 0, size: 0, init: function () {
        this.clear();
    ...
    Trie.Entry = Class.extend({_key: null, _value: null, init: function (key, value) {
    ...
    Trie.Node = Class.extend({_value: null, _nextMap: null, setValue: function (value) {
        this._value = value;
